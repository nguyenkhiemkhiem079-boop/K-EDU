...
assert.ok(firebase.includes("collection('quiz_answer_keys')"));
console.log('Cloud sync queue, local-first persistence, Firebase Auth boundary, and answer-key separation checks passed.');
