...
| :--- | :--- | :--- | :--- |
| **OFFICIAL (Chính thức)** | 6 | 5.7% | Được phép |
| **FULL_TEST (Đề thi thử hoàn chỉnh)** | 50 | 47.2% | Được phép |
| **SUBJECT_BANK (Ngân hàng theo môn)** | 31 | 29.2% | Được phép |
| **PENDING (Chờ thẩm định / Ngoài phạm vi)** | 6 | 5.7% | Bị chặn |
| **DUPLICATE (Bản sao trùng lặp byte)** | 13 | 12.3% | Bị chặn |
| **TỔNG CỘNG TÀI LIỆU NGUỒN** | **106** | **100.0%** | **87 tệp hợp lệ** |
